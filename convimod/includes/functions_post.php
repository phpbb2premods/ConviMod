...
//	, $attribute_id
//-- modify
function submit_post($mode, &$post_data, &$message, &$meta, &$forum_id, &$topic_id, &$post_id, &$poll_id, &$topic_type, &$bbcode_on, &$html_on, &$smilies_on, &$attach_sig, &$bbcode_uid, $post_username, $post_subject, $post_sub_title, $post_message, $poll_title, &$poll_options, &$poll_length, $attribute_id)
...
//-- add
	$edited_sql = ($mode == 'editpost') ? ", post_edit_time = $current_time, post_edit_user_id = ".$userdata['user_id'].", post_edit_count = post_edit_count + 1 " : "";
...
//
function user_notification($mode, &$post_data, &$topic_title, &$forum_id, &$topic_id, &$post_id, &$notify_user, &$poster_name)
{
	global $board_config, $lang, $db, $phpbb_root_path, $phpEx;
	global $userdata, $user_ip;
