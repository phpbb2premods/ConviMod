...
//	&$message
//-- modify
function display_avatar_gallery($mode, &$category, &$user_id, &$email, &$current_email, &$coppa, &$username, &$browser, &$email, &$new_password, &$cur_password, &$password_confirm, &$icq, &$aim, &$msn, &$yim, &$website, &$location, &$occupation, &$interests, &$bday_day, &$bday_month, &$bday_year, &$flag, &$message, &$viewemail, &$notifypm, &$popup_pm, &$notifyreply, &$attachsig, &$allowhtml, &$allowbbcode, &$allowsmilies, &$hideonline, &$style, &$language, &$timezone, &$dateformat, &$session_id, &$user_qp_settings)
//-- fin preMOD ConviMod --------------------------------------
//-- fin mod : birthday --------------------------------------------------------
...
//	'message'
//-- modify
	$params = array('coppa', 'user_id', 'username', 'browser', 'email', 'current_email', 'cur_password', 'new_password', 'password_confirm', 'icq', 'aim', 'msn', 'yim', 'website', 'location', 'occupation', 'interests', 'bday_day', 'bday_month', 'bday_year', 'flag', 'message', 'viewemail', 'notifypm', 'popup_pm', 'notifyreply', 'attachsig', 'allowhtml', 'allowbbcode', 'allowsmilies', 'hideonline', 'style', 'language', 'timezone', 'dateformat', 'user_qp', 'user_qp_show', 'user_qp_subject', 'user_qp_bbcode', 'user_qp_smilies', 'user_qp_more');
//-- fin preMOD ConviMod --------------------------------------
//-- fin mod : birthday --------------------------------------------------------
//-- fin mod : quick post es ---------------------------------------------------
//-- fin mod : browsers list ---------------------------------------------------
