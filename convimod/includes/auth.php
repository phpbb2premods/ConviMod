...
//	, a.auth_cloneposts
//-- Modify
			$a_sql = 'a.auth_view, a.auth_read, a.auth_post, a.auth_reply, a.auth_edit, a.auth_delete, a.auth_cloneposts, a.auth_sticky, a.auth_announce, a.auth_global_announce, a.auth_vote, a.auth_pollcreate';
//-- fin mod : Clone Post -----------------------------------------------------
//-- mod : Clone Post ---------------------------------------------------------
// Here we added
//	, 'auth_cloneposts'
//-- Modify
			$auth_fields = array('auth_view', 'auth_read', 'auth_post', 'auth_reply', 'auth_edit', 'auth_delete', 'auth_cloneposts', 'auth_sticky', 'auth_announce', 'auth_global_announce', 'auth_vote', 'auth_pollcreate');
//-- fin mod : Clone Post -----------------------------------------------------
			break;
