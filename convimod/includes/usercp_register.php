...
//	$message
//-- modify
	validate_optional_fields($icq, $aim, $msn, $yim, $website, $location, $occupation, $interests, $message);
//-- fin preMOD ConviMod --------------------------------------
...
//	$message
//-- modify
	display_avatar_gallery($mode, $avatar_category, $user_id, $email, $current_email, $coppa, $username, $browser, $email, $new_password, $cur_password, $password_confirm, $icq, $aim, $msn, $yim, $website, $location, $occupation, $interests, $bday_day, $bday_month, $bday_year, $flag, $message, $viewemail, $notifypm, $popup_pm, $notifyreply, $attachsig, $allowhtml, $allowbbcode, $allowsmilies, $allowviewonline, $user_style, $user_lang, $user_timezone, $user_dateformat, $userdata['session_id'], $user_qp_settings);
//-- fin preMOD ConviMod --------------------------------------
//-- fin mod : birthday --------------------------------------------------------
//-- fin mod : quick post es ---------------------------------------------------
//-- fin mod : browsers list ---------------------------------------------------
