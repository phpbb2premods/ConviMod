...
* @version $Id: functions_attributes.php,v 1.1.5 2008/07/03 22:20 PastisD Exp $
	...
	*/
	function attr(&$topic_title, $topic_attribute)
	{
		...
		if ( !empty($topic_attribute) )
		{
			...
			return $topic_title = $this->attr[$attr_id]['attribute_position'] ? $topic_title . ' ' . $attribute : $attribute . ' ' . $topic_title;
		}
		else
		{
			return $topic_title;
