...
$faq[] = array("Comment puis-je supprimer un fichier joint ?", "Pour supprimer des fichiers joints, vous avez besoin d'&eacute;diter votre message et devez cliquer sur <em>Supprimer le fichier joint</em>, &agrave; c&ocirc;t&eacute; du fichier joint que vous souhaitez supprimer dans la bo&icirc;te des <em>Fichiers upload&eacute;s</em>. Le fichier joint sera supprim&eacute; lorsque vous cliquerez sur <em>Envoyer</em> pour valider le message &eacute;dit&eacute;.");

$faq[] = array("Comment puis-je mettre &agrave; jour le commentaire d'un fichier ?", "Pour mettre &agrave; jour le commentaire d'un fichier, vous avez besoin d'&eacute;diter votre message, &eacute;ditez le texte dans le champ <em>Commentaire</em> et cliquez sur le bouton <em>Mettre &agrave; jour le commentaire</em>, &agrave; c&ocirc;t&eacute; du commentaire du fichier que vous souhaitez mettre &agrave; jour dans la bo&icirc;te des <em>Fichiers upload&eacute;s</em>. Le commentaire du fichier sera mis &agrave; jour lorsque vous cliquerez sur <em>Envoyer</em> pour valider le message &eacute;dit&eacute;.");
