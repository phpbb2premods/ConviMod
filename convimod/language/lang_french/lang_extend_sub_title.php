...
if ( $lang_extend_admin )
{
	...
	$lang['Sub_title_length_explain'] = 'Choisissez la longueur en nombre de caract&egrave;res des sous-titres (description) des messages. Renseignez cette valeur &agrave; 0 si vous ne d&eacute;sirez pas afficher les sous-titres.';
}
