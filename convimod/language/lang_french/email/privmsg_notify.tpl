...
{POSTER_USERNAME} vous a envoyé un nouveau message privé sur votre compte sur "{SITENAME}" et avez demandé à être averti dans ce cas. Vous pouvez voir votre nouveau message en cliquant sur le lien suivant:
