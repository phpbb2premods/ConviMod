...
Vous recevez cet e-mail parce que vous surveillez le sujet "{TOPIC_TITLE}" sur {SITENAME}. Ce sujet a reçu une réponse de la part de "{POSTER_NAME}" depuis votre dernière visite. Vous pouvez utiliser le lien suivant pour voir les réponses qui ont été faites; aucune autre notification ne vous sera envoyée jusqu'à ce que vous visitiez le sujet.
