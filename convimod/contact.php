...
if(isset($HTTP_POST_VARS['submit']))
{
	...
	$emailer->assign_vars(array(
		'REAL_NAME' => preg_replace($html_chars_match, $html_chars_replace, substr(str_replace("\'", "'", $real_name), 0, strlen($real_name))),
		'USERNAME' => preg_replace($html_chars_match, $html_chars_replace, substr(str_replace("\'", "'", $user_name), 0, strlen($user_name))),
		'EMAIL' => $email,
