<form action="{S_GROUPCP_ACTION}" method="post">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
	  <td width="35" align="left"><img src="{I_HDR_GROUPS}" alt="" /></td>
	  <td class="hdr" width="100%" align="left" nowrap="nowrap">{L_GROUP_INFORMATION}</td>
...
<form action="{S_GROUPCP_ACTION}" method="post" name="post">
  ...
  <table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	...
	<tr>
	  <td class="hdr" colspan="8" height="28"><span class="cattitle">{L_GROUP_OWNER}</span></td>
	</tr>
	<tr>
	...
	<!-- BEGIN member_type -->
	<tr>
	  <td class="hdr" colspan="8" height="28"><span class="cattitle">{member_row.member_type.L_TYPE}</span></td>
	</tr>
	<!-- END member_type -->
	<tr>
	...
	<tr>
		<td class="catBottom" colspan="8" align="right">
			<span class="cattitle"><input type="submit" name="remove" value="{L_REMOVE_SELECTED}" class="mainoption" />
