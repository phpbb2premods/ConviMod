...
<b><center>{L_UACP} :: <span {STYLE}>{USERNAME}</span></center></b>
...
<form method="post" name="attach_list" action="{S_MODE_ACTION}">
	...
	<tr> 
		<th height="25" class="hdra">#</th>
		<th class="hdra">{L_FILENAME}</th>
		<th class="hdra">{L_FILECOMMENT}</th>
		<th class="hdra">{L_EXTENSION}</th>
		<th class="hdra">{L_SIZE}</th>
		<th class="hdra">{L_DOWNLOADS}</th>
		<th class="hdra">{L_POST_TIME}</th>
		<th class="hdra">{L_POSTED_IN_TOPIC}</th>
