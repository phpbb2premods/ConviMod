...
<form method="post" action="{S_PRIVMSGS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0">
	<tr>
	  ...
	  <td class="nav" width="50%"><a href="{U_INDEX}" class="nav">{L_INDEX}</a></td>
	  <td class="nav" align="right" width="50%"><span class="nav"><a href="{U_PRIVMSG_PREVIOUS}">{L_PRIVMSG_PREVIOUS}</a> :: <a href="{U_PRIVMSG_NEXT}">{L_PRIVMSG_NEXT}</a></span></td>
	</tr>
  </table>
  ...
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
	  ...
	  <td class="hdr" width="100%" align="left" nowrap="nowrap">{BOX_NAME} :: {L_MESSAGE}</td>
