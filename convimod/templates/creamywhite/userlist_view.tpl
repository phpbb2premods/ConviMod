...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
	<td width="35" align="left"><img src="{I_HDR_LEFT}" alt="" /></td>
	<td class="hdr" width="100%" align="left" nowrap="nowrap">{L_PROFILE}</td>
	<td width="35" align="right"><img src="{I_HDR_RIGHT}" alt="" /></td>
  </tr>
</table>
...
<tr>
	...
	<!-- BEGIN user_is_admin -->
	<tr>
		<td valign="top" align="right" nowrap="nowrap"><span class="gen">{L_USER_RULES}:</span></td>
		<td><strong class="gen">{USER_RULES}</strong></td>
	</tr>
	<!-- END user_is_admin -->
	</table></td>
</tr>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
	<td width="35" align="left"><img src="{I_HDR_LEFT}" alt="" /></td>
	<td class="hdr" width="100%" align="left" nowrap="nowrap">{L_CONTACT}</td>
	<td width="35" align="right"><img src="{I_HDR_RIGHT}" alt="" /></td>
  </tr>
</table>
<table class="forumline cells" width="100%" cellspacing="1">
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
	<td width="35" align="left"><img src="{I_HDR_LEFT}" alt="" /></td>
	<td class="hdr" width="100%" align="left" nowrap="nowrap">{L_ATTACHED_FILES}</td>
	<td width="35" align="right"><img src="{I_HDR_RIGHT}" alt="" /></td>
  </tr>
</table>
<table class="forumline cells" width="100%" cellspacing="1">
  <tr>
	<td class="row1"><table class="subcells" cellspacing="1">
		<tr>
			...
			<td width="100%"><table width="175" cellspacing="1" class="bodyline cells">
				<tr> 
					<td colspan="3" width="100%" class="row2"><table cellspacing="0" cellpadding="1" border="0">
						<tr> 
				...
				<br />
				<b class="genmed">[{UPLOADED} / {QUOTA} / {PERCENT_FULL}]</b><br />
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
	<td width="35" align="left"><img src="{I_HDR_LEFT}" alt="" /></td>
	<td class="hdr" width="100%" align="left" nowrap="nowrap">{L_USER_STATS}</td>
	<td width="35" align="right"><img src="{I_HDR_RIGHT}" alt="" /></td>
  </tr>
</table>
<table class="forumline cells" width="100%" cellspacing="1">
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
	<td width="35" align="left"><img src="{I_HDR_LEFT}" alt="" /></td>
	<td class="hdr" width="100%" align="left" nowrap="nowrap">{L_SIGNATURE}</td>
	<td width="35" align="right"><img src="{I_HDR_RIGHT}" alt="" /></td>
  </tr>
</table>
<table class="forumline cells" width="100%" cellspacing="1">
