<form method="post" action="{S_SPLIT_ACTION}">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
	  ...
	  <td class="hdr" width="100%" align="left" nowrap="nowrap">{L_SPLIT_TOPIC}</td>
  ...
  <table class="forumline" width="100%" cellpadding="3" cellspacing="1" border="0">
	...
	<tr>
	  <th class="hdra" nowrap="nowrap">{L_AUTHOR}</th>
	  <th class="hdra" nowrap="nowrap">{L_MESSAGE}</th>
	  <th class="hdra" nowrap="nowrap">{L_SELECT}</th>
	</tr>
	<!-- BEGIN postrow -->
	<tr>
