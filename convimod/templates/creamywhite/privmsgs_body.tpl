...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
	...
	<td align="right"> 
	  <!-- BEGIN switch_box_size_notice -->
	  <table class="boxline" width="175" cellspacing="1" cellpadding="2" border="0">
		<tr>
		  <td class="rowBox" colspan="3" width="175" nowrap="nowrap"><span class="gensmall">{BOX_SIZE_STATUS}</span></td>
		</tr>
		<tr>
		  <td class="rowBox" colspan="3" width="175"><table cellspacing="0" cellpadding="1" border="0">
			<tr>
		...
		<tr>
		  <td class="rowBox" width="33%"><span class="gensmall">0%</span></td>
		  <td class="rowBox" width="34%" align="center"><span class="gensmall">50%</span></td>
		  <td class="rowBox" width="33%" align="right"><span class="gensmall">100%</span></td>
		</tr>
	  </table>
	  <!-- END switch_box_size_notice -->
	</td>
...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
	  ...
	  <td class="hdr" width="100%" align="left" nowrap="nowrap">{PAGE_TITLE}</td>
	...
	<tr>
	  ...
	  <td align="right" valign="top" nowrap="nowrap">
		<table width="100%" height="12" border="0" cellspacing="0" cellpadding="0">
		  <tr> 
			<td align="left" height="12" valign="top"><img alt="" src="{I_TAB_LEFT}" /></td>
			<td class="ftr" height="12" nowrap="nowrap"><a href="#top"><img alt="" src="{I_TAB_TOP}" border="0" /></a></td>
			<td class="ftr" height="12" nowrap="nowrap"><a href="javascript:select_switch(true);" class="gensmall"><img alt="{L_MARK_ALL}" src="{I_PM_ALL}" title="{L_MARK_ALL}" border="0" /></a></td>
			<td class="ftr" height="12" nowrap="nowrap"><a href="javascript:select_switch(false);" class="gensmall"><img alt="{L_UNMARK_ALL}" src="{I_PM_NO}" title="{L_UNMARK_ALL}" border="0" /></a></td>
			<td height="12" align="left" valign="top"><img alt="" src="{I_TAB_RIGHT}" /></td>
		  </tr>
		</table>
