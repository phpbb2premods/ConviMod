...
<tr>
	<th class="hdra">{L_VERSION_INFORMATION}</th>
</tr>
<!-- BEGIN author -->
<tr>
	<td class="row1"><span class="genmed">
		...
		<!-- BEGIN latest -->&#150;&nbsp;{L_LATEST_VERSION}:&nbsp;<span style="color:<!-- BEGIN success -->#1F5B13<!-- BEGINELSE success -->#990000<!-- END success -->; font-weight:bold;">{author.mod.LATEST_VERSION}</span><br class="both" /><!-- END latest --><!-- BEGIN dev -->&#150&nbsp;{L_DEV_VERSION}:&nbsp;<span style="color:#000000; font-weight:bold;">{author.mod.DEV}</span><br class="both" /><!-- END dev -->
