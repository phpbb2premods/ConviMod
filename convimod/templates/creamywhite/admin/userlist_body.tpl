...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	<tr>
		<th width="3%" class="hdra"><input type="checkbox" onclick="javascript:selectAll();" /></th>
		<th width="2%" onClick="javascript:openAll();" id="top_folder" class="hdra"><img src='{I_ARROW_RIGHT}'></th>
		<th width="15%" class="hdra">{L_USERNAME}</th>
		<th width="7%" class="hdra">{L_ACTIVE}</th>
		<th width="15%" class="hdra">{L_JOINED}</th>
		<th width="20%" class="hdra">{L_ACTIVITY}</th>
		<th width="8%" class="hdra">{L_POSTS}</th>
		<th width="15%" class="hdra">{L_WEBSITE}</th>
		<th width="15%" class="hdra">{L_EMAIL}</th>
	</tr>
	<!-- BEGIN user_row -->
	<tr>
		...
		<td class="{user_row.ROW_CLASS}" align="center" nowrap="nowrap"><span id="oI[]" onClick="javascript:handleClick('{user_row.USER_ID}');"><div id="{user_row.USER_ID}" name="oF[]"><img src='{I_ARROW_RIGHT}'></div></span></td>
		...
		<td class="{user_row.ROW_CLASS}" align="center"><span class="gen">{user_row.WEBSITE}</span></td>
		<td class="{user_row.ROW_CLASS}" align="center"a href="mailto:{user_row.EMAIL}" class="gen">{user_row.EMAIL}</a></td>
	</tr>
