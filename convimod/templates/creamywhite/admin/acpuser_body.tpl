...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
		<th class="hdra" colspan="2" height="25" valign="middle">{L_REGISTRATION_INFO}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="hdra" colspan="2" height="25" valign="middle">{L_PROFILE_INFO}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="hdra" colspan="2" height="25" valign="middle">{L_PREFERENCES}</th>
	</tr>
	<tr> 
	...
	<tr> 
		<th class="hdra" colspan="2" height="25" valign="middle">{L_REGISTRATION_OPTIONS}</th>
	</tr>
	<tr>
