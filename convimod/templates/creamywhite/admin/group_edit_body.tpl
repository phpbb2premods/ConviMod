...
<form action="{S_GROUP_ACTION}" method="post" name="post">
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
	  ...
	  <td class="hdr" width="100%" align="left" nowrap="nowrap">{L_GROUP_EDIT_DELETE}</td>
	  <td width="35" align="right"><img src="{I_HDR_RIGHT}" alt="" /></td>
	</tr>
  </table>
  <table width="100%" class="forumline" cellpadding="3" cellspacing="1" border="0" align="center">
	<tr>
