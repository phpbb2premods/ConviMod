...
<table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	<tr>
	  <th class="hdra" colspan="2">{L_ATTACHMENT_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
	  <th class="hdra" colspan="2">{L_ATTACHMENT_FILESIZE_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
	  <th class="hdra" colspan="2">{L_ATTACHMENT_NUMBER_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
	  <th class="hdra" colspan="2">{L_ATTACHMENT_OPTIONS_SETTINGS}</th>
	</tr>
	<tr>
...
<!-- BEGIN switch_ftp -->
	...
	<tr>
	  <th class="hdra" colspan="2">{L_ATTACHMENT_FTP_SETTINGS}</th>
	</tr>
	<tr>
