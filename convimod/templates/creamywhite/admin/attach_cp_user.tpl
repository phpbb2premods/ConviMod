...
<!--	  <td align="left" nowrap="nowrap"><span class="gen"><a class="gen" href="{U_BACK}" />Back</a></span></td> -->
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	<tr> 
	  ...
	  <th class="hdra">{L_USERNAME}</th>
	  <th class="hdra">{L_ATTACHMENTS}</th>
	  <th class="hdra">{L_TOTAL_SIZE}</th>
	</tr>
	<!-- BEGIN memberrow -->
	<tr> 
	  <td class="{memberrow.ROW_CLASS}" align="center"><span class="gen">&nbsp;{memberrow.ROW_NUMBER}&nbsp;</span></td>
	  <td class="{memberrow.ROW_CLASS}" align="center"><span class="gen"><a href="{memberrow.U_VIEW_MEMBER}"{memberrow.STYLE}>{memberrow.USERNAME}</a></span></td>
