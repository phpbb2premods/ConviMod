...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
  <tr>
	<th width="25%" nowrap="nowrap" height="25" class="hdra">{L_QUERY}</th>
	<th width="25%" height="25" class="hdra">{L_RECORDS}</th>
  </tr>
  <tr>
...
<table border="0" cellpadding="4" cellspacing="1" width="98%">
	<tr>
		<th align="center" width="15%" height="25" class="hdra" nowrap="nowrap">{L_USER}</th>
		<th align="center" class="hdra" nowrap="nowrap">{L_SEARCH_PHRASES}</th>
	</tr>
