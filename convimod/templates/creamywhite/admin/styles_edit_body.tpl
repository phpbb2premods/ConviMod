...
<form action="{S_THEME_ACTION}" method="post">
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
	  ...
	  <td class="hdr" width="100%" align="left" nowrap="nowrap">{L_THEMES_TITLE}</td>
  ...
  <table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	...
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="tr_color1_name" value="{TR_COLOR1_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="tr_color2_name" value="{TR_COLOR2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="tr_color3_name" value="{TR_COLOR3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="tr_class1_name" value="{TR_CLASS1_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="tr_class2_name" value="{TR_CLASS2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="tr_class3_name" value="{TR_CLASS3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="th_color1_name" value="{TH_COLOR1_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="th_color2_name" value="{TH_COLOR2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="th_color3_name" value="{TH_COLOR3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="th_class1_name" value="{TH_CLASS1_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="th_class2_name" value="{TH_CLASS2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="th_class3_name" value="{TH_CLASS3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="td_color1_name" value="{TD_COLOR1_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="td_color2_name" value="{TD_COLOR2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="td_color3_name" value="{TD_COLOR3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="td_class1_name" value="{TD_CLASS1_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="td_class2_name" value="{TD_CLASS2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="td_class3_name" value="{TD_CLASS3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontface1_name" value="{FONTFACE1_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontface2_name" value="{FONTFACE2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontface3_name" value="{FONTFACE3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontsize1_name" value="{FONTSIZE1_NAME}" /></td>	
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontsize2_name" value="{FONTSIZE2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontsize3_name" value="{FONTSIZE3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontcolor1_name" value="{FONTCOLOR1_NAME}" /></td>	
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontcolor2_name" value="{FONTCOLOR2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="fontcolor3_name" value="{FONTCOLOR3_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="span_class1_name" value="{SPAN_CLASS1_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="span_class2_name" value="{SPAN_CLASS2_NAME}" /></td>
	</tr>
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="25" maxlength="50" name="span_class3_name" value="{SPAN_CLASS3_NAME}" /></td>
	</tr>
	<tr>
