...
<form action="{S_BOTS_ACTION}" method="post"><table width="90%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<th nowrap="nowrap" class="hdra">{L_BOT_NAME}</th>
		<th nowrap="nowrap" class="hdra">{L_BOT_PAGES}</th>
		<th nowrap="nowrap" class="hdra">{L_BOT_VISITS}</th>
		<th nowrap="nowrap" class="hdra">{L_BOT_LAST_VISIT}</th>
		<th colspan="2" nowrap="nowrap" class="hdra">{L_BOT_OPTIONS}</th>
		<th nowrap="nowrap" class="hdra">{L_BOT_MARK}</th>
	</tr>
...
<table width="90%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<th nowrap="nowrap" class="hdra">{L_BOT_NAME}</th>
		<th nowrap="nowrap" class="hdra">{L_BOT_IP}</th>
		<th nowrap="nowrap" class="hdra">{L_BOT_AGENT}</th>
		<th colspan="2" nowrap="nowrap" class="hdra">{L_BOT_OPTIONS}</th>
	</tr>
