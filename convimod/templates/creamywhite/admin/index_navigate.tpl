...
<table width="100%" cellpadding="4" cellspacing="0" border="0" align="center">
  ...
  <tr>
	<td align="center"><table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	  <tr>
		<th height="25" class="hdra">{L_ADMIN}</th>
	  </tr>
	  <tr>
		<td class="row1"><span class="genmed"><a href="{U_ADMIN_INDEX}" target="main">{L_ADMIN_INDEX}</a></span></td>
	  </tr>
	  <!-- Admin Session Logout -->
	  <tr> 
		<td class="row1"><span class="genmed"><a href="{U_ADMIN_LOGOUT}" target="_parent">{L_ADMIN_LOGOUT}</a></span></td>
	  </tr>
	  <!-- Admin Session Logout -->
	  <tr>
		<td class="row1"><span class="genmed"><a href="{U_FORUM_INDEX}" target="main">{L_PREVIEW_FORUM}</a></span></td>
	  </tr>
	  <!-- +Reorder ACP Categories -->
	  <tr>
		<td class="row1">
			<span class="genmed">
				<a href="{U_REORDER_CATS}" target="main">{L_REORDER_CATS}</a>
			</span>
		</td>
	  </tr>
	  <!-- -Reorder ACP Categories -->
	  <!-- BEGIN catrow -->
	  <tr>
		<th class="thTop" height="28" style="cursor:pointer;cursor:hand;" onclick="onMenuCatClick('{catrow.MENU_CAT_ID}');">{catrow.ADMIN_CATEGORY}</th>
	  </tr>
	  <tr> 
		<td class="row1">
	  ...
	  <!-- BEGIN modulerow -->
	  <tr>
		<td class="row1"><div id="menuCat_{catrow.MENU_CAT_ID}_{catrow.modulerow.ROW_COUNT}" style="display:block;" class="genmed"><a href="{catrow.modulerow.U_ADMIN_MODULE}" target="main">{catrow.modulerow.ADMIN_MODULE}</a></div></td>
	  </tr>
	  <!-- END modulerow -->
				</table>
			</div>
