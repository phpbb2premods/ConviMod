...
<form method="post" action="{S_ATTR_ACTION}"><table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	<tr>
		<th class="hdra">{L_ATTRIBUTE}</th>
		<th class="hdra">{L_COLOR}</th>
		<th class="hdra">{L_PERMISSIONS}</th>
		<th class="hdra">{L_DATE_FORMAT}</th>
		<th class="hdra">{L_POSITION}</th>
		<th class="hdra">{L_ACTION}</th>
	</tr>
	<!-- BEGIN attribute -->
	<tr>
