...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
  <tr>
	<th width="25%" nowrap="nowrap" height="25" class="hdra">{L_STATISTIC}</th>
...
<table width="98%" cellspacing="1" cellpadding="2" border="0">
	<tr>
	   	<th nowrap="nowrap" height="25" class="hdra">{L_DEFINE_DATESPAN}</th>
	</tr>
	<tr>
...
<table width="98%" cellspacing="1" cellpadding="2" border="0">
	<tr>
	    <th width="15%" class="hdra">{L_RESULT}</th>
	    <th width="15%" class="hdra">{L_PERCENTAGE}</th>
	    <th class="hdra">{L_SEARCH_PHRASE}</th>
	</tr>
	<!-- BEGIN phraserow -->
	<tr>
...
<table width="98%" cellspacing="1" cellpadding="2" border="0">
	<tr>
	    <th width="15%" class="hdra">{L_RESULT}</th>
	    <th width="15%" class="hdra">{L_PERCENTAGE}</th>
	    <th class="hdra">{L_SEARCH_TERMS}</th>
	</tr>
	<!-- BEGIN termsrow -->
	<tr>
...
<table width="98%" cellspacing="1" cellpadding="2" border="0">
	<tr>
	    <th width="15%" class="hdra">{L_RESULT}</th>
	    <th width="15%" class="hdra">{L_PERCENTAGE}</th>
	    <th class="hdra">{L_SEARCH_FIELDS}</th>
	</tr>
	<!-- BEGIN fieldsrow -->
	<tr>
