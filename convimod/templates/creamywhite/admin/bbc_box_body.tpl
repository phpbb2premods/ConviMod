...
<form method="post" action="{S_BBC_BOX_ACTION}"><table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	<tr>
		<th class="hdra">{L_BBC_NAME}</th>
		<th class="hdra">{L_BBC_IMG_DISPLAY}</th>
        	<th class="hdra">{L_BBC_BEFORE}</th>
		<th class="hdra">{L_BBC_AFTER}</th>
		<th class="hdra">{L_BBC_HELPLINE}</th>
		<th class="hdra">{L_BBC_IMG}</th>
		<th class="hdra">{L_BBC_DIVIDER}</th>
		<th class="hdra">{L_EDIT}</th>
