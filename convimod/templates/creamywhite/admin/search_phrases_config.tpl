...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
  <tr>
	<th width="25%" nowrap="nowrap" height="25" class="hdra">{L_OPTION}</th>
	<th width="25%" height="25" class="hdra">{L_VALUE}</th>
  </tr>
  <tr>
...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<th nowrap="nowrap" height="25" class="hdra" colspan="2">{L_BACKUP}</th>
	</tr>
	<tr>
...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<th width="25%" nowrap="nowrap" height="25" class="hdra">{L_DELETE_SELECTIVE}</th>
	</tr>
	<tr>
...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<th align="center" height="25" class="hdra" nowrap="nowrap">{L_PURGE_SEARCH_PHRASES}</th>
	</tr>
	<tr>
...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<th align="center" colspan="2" height="25" class="hdra" nowrap="nowrap">{L_TIDY}</th>
	</tr>
	<tr>
...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<th align="center" height="25" class="hdra" nowrap="nowrap">{L_VERSION_CHECK}</th>
	</tr>
	<tr>
...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<th align="center" height="25" class="hdra" nowrap="nowrap">{L_STOPWORDS}</th>
	</tr>
	<!-- BEGIN stopwords_row -->
	<tr>
...
<table width="98%" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<th align="center" height="25" class="hdra" nowrap="nowrap" colspan="2">{L_SYNONYMS}</th>
	</tr>
	<!-- BEGIN synonyms_row -->
	<tr>
