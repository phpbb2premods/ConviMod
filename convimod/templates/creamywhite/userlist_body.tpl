...
<tr>
	...
	<th class="thTop nowrap" width="15%"><a href="{U_SORT_LASTLOGIN}">{L_LASTLOGIN}</a></th>
...
<tr>
	...
	<td class="{usrlist.ROW_CLASS} hcenter"><span class="gensmall">{usrlist.USER_LASTLOGIN}</span></td>
...
<!-- BEGIN empty -->
<tr>
	<td class="row1 middle" colspan="10"><span class="gen">{L_EMPTY}</span></td>
</tr>
<!-- END empty -->
<tr>
	<td class="catBottom hright" colspan="10"><span class="gensmall">&nbsp;</span></td>
</tr>
</table>
<table width="100%" height="9" cellspacing="0" cellpadding="0" border="0">
  <tr> 
