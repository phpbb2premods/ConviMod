...
$forum_auth_fields = array('auth_view', 'auth_read', 'auth_post', 'auth_reply', 'auth_edit', 'auth_delete', 'auth_cloneposts', 'auth_sticky', 'auth_global_announce', 'auth_announce', 'auth_vote', 'auth_pollcreate');
	...
	if ( $mode == 'user' && $HTTP_POST_VARS['userlevel'] == 'admin' && $user_level != ADMIN )
	{
		...
		if ( $userdata['user_id'] != $user_id )
		{
			$sql = 'UPDATE ' . USERS_TABLE . '
				SET user_level = ' . ADMIN . ', user_acp_password = user_password
...
//-- fin mod : admin userlist --------------------------------------------------
		...
		{
			$sql = "UPDATE " . USERS_TABLE . " 
				SET user_level = " . USER . ", user_acp_password = '' 
