...
#
# ConviMod - MySQL basic
# v.154 - 2008/08/06 - Dragons
#
...
# -- Demo Topic
INSERT INTO phpbb_topics (topic_id, topic_title, topic_poster, topic_time, topic_views, topic_replies, forum_id, topic_status, topic_type, topic_vote, topic_first_post_id, topic_last_post_id) VALUES (1, 'Bienvenue sur ConviMod 1.5.2 - Welcome to ConviMod 1.5.2', 2, '972086460', 0, 0, 1, 0, 0, 0, 1, 1);
...
# -- Replace Disable Board Message in ConviMod V1.4.6
...
# -- Add On Hide for BBcode Box Reloaded
...
VALUES
('run_stats_enable', 1),
('run_stats_show_reg_users', 0),
('run_stats_query_option', 0),
('run_stats_warn_time', '0.01');
...
INSERT INTO phpbb_contact_config VALUES ('contact_version', '9.5.1');
...
# -- Search Data
# -- add to ConviMod V1.4.8
INSERT INTO phpbb_config ( config_name , config_value ) VALUES ('search_data', '');

# -- Birthday Event
# -- MàJ to ConviMod V1.4.8
...
ALTER TABLE phpbb_posts_text ADD post_sub_title VARCHAR(255) NULL DEFAULT '';
ALTER TABLE phpbb_topics ADD topic_sub_title VARCHAR(255) NULL DEFAULT '';
