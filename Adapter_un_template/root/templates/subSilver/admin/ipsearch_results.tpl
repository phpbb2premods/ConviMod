...
<thead>
<tr>
	<th class="thHead">{L_IPSEARCH_USERS}</th>
	<th class="thHead">{L_IPSEARCH_IP}</th>
	<th class="thHead">{L_POSTS}</th>
	<th class="thHead">{L_IPSEARCH_POLL_VOTES}</th>
	<th class="thHead">{L_IPSEARCH_SESSIONS}</th>
	<th class="thHead">{L_IPSEARCH_KEYS}</th>
<!-- BEGIN regged -->
	<th class="thHead">{L_IPSEARCH_ACCOUNT}</th>
<!-- END regged -->
	<th class="thHead">{L_IPSEARCH_PMS}</th>
</tr>
</thead>
<tbody>
<!-- BEGIN users -->
	<!-- BEGIN header -->
	<tr>
		<td class="catHead" height="28" colspan="10"><span class="cattitle">{users.HEADER}</span></td>
	</tr>
	<!-- END header -->
	<!-- BEGIN total -->
	<tr class="row4">
